...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('battery_percentage_status_icon','0');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('show_clock_period','0');"
#clock text color
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('spn_label_color','-2105377');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('no_notifications_color','-6908266');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('clear_button_label_color','-16777216');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('ongoing_notifications_color','-6908266');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('latest_notifications_color','-6908266');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('notifications_text_color','-9737365');"
...
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('notifications_time_color','-9737365');"
#expanded widget color
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "DELETE FROM \"system\" WHERE \"name\" = \"expanded_widget_color\";"
/system/xbin/sqlite3 /data/data/com.android.providers.settings/databases/settings.db "INSERT INTO \"system\" (\"name\", \"value\") VALUES('expanded_widget_color','-16777216');"
echo "</map>" >> com.cyanogenmod.cmparts_preferences.xml
...
if [ -f launcher.preferences.almostnexus.xml ]; then
  cat launcher.preferences.almostnexus.xml | grep -v uiNewSelectors > launcher.preferences.almostnexus.xml.new && rm launcher.preferences.almostnexus.xml && mv launcher.preferences.almostnexus.xml.new launcher.preferences.almostnexus.xml
  ...
  cat launcher.preferences.almostnexus.xml | grep -v drawerColumnsPortrait > launcher.preferences.almostnexus.xml.new && rm launcher.preferences.almostnexus.xml && mv launcher.preferences.almostnexus.xml.new launcher.preferences.almostnexus.xml
...
echo "<boolean name=\"uiNewSelectors\" value=\"false\" />" >> launcher.preferences.almostnexus.xml
echo "<int name=\"highlights_color\" value=\"536870912\" />" >> launcher.preferences.almostnexus.xml
echo "<int name=\"highlights_color_focus\" value=\"-2147483648\" />" >> launcher.preferences.almostnexus.xml
echo "<int name=\"drawerColumnsPortrait\" value=\"3\" />" >> launcher.preferences.almostnexus.xml
echo "</map>" >> launcher.preferences.almostnexus.xml

#clockr alternate push colors
if [ -d /data/data/com.zehro.android.clockrEvolution/shared_prefs ]; then
  cd /data/data/com.zehro.android.clockrEvolution/shared_prefs
else
  mkdir -p /data/data/com.zehro.android.clockrEvolution/shared_prefs
  cd /data/data/com.zehro.android.clockrEvolution/shared_prefs
fi
if [ -f com.zehro.android.clockrEvolution_preferences.xml ]; then
  cat com.zehro.android.clockrEvolution_preferences.xml | grep -v date_middle_color > com.zehro.android.clockrEvolution_preferences.xml.new && rm com.zehro.android.clockrEvolution_preferences.xml && mv com.zehro.android.clockrEvolution_preferences.xml.new com.zehro.android.clockrEvolution_preferences.xml
  cat com.zehro.android.clockrEvolution_preferences.xml | grep -v date_middle_color6 > com.zehro.android.clockrEvolution_preferences.xml.new && rm com.zehro.android.clockrEvolution_preferences.xml && mv com.zehro.android.clockrEvolution_preferences.xml.new com.zehro.android.clockrEvolution_preferences.xml
  cat com.zehro.android.clockrEvolution_preferences.xml | grep -v date_time_color > com.zehro.android.clockrEvolution_preferences.xml.new && rm com.zehro.android.clockrEvolution_preferences.xml && mv com.zehro.android.clockrEvolution_preferences.xml.new com.zehro.android.clockrEvolution_preferences.xml
  cat com.zehro.android.clockrEvolution_preferences.xml | grep -v date_time_color6 > com.zehro.android.clockrEvolution_preferences.xml.new && rm com.zehro.android.clockrEvolution_preferences.xml && mv com.zehro.android.clockrEvolution_preferences.xml.new com.zehro.android.clockrEvolution_preferences.xml
  cat com.zehro.android.clockrEvolution_preferences.xml | grep -v "</map>" > com.zehro.android.clockrEvolution_preferences.xml.new && rm com.zehro.android.clockrEvolution_preferences.xml && mv com.zehro.android.clockrEvolution_preferences.xml.new com.zehro.android.clockrEvolution_preferences.xml
else
  echo "<?xml version='1.0' encoding='utf-8' standalone='yes' ?>" > com.zehro.android.clockrEvolution_preferences.xml
  echo "<map>" >> com.zehro.android.clockrEvolution_preferences.xml
fi
echo "<int name=\"date_middle_color\" value=\"-6170574\" />" >> com.zehro.android.clockrEvolution_preferences.xml
echo "<int name=\"date_middle_color6\" value=\"-6170574\" />" >> com.zehro.android.clockrEvolution_preferences.xml
echo "<int name=\"time_middle_color\" value=\"-6170574\" />" >> com.zehro.android.clockrEvolution_preferences.xml
echo "<int name=\"time_middle_color6\" value=\"-6170574\" />" >> com.zehro.android.clockrEvolution_preferences.xml
echo "</map>" >> com.zehro.android.clockrEvolution_preferences.xml
cd $NCWD
